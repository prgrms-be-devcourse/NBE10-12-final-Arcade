...
export const MOCK_CONTESTS: Contest[] = [
  {
    ...
    applicationPeriodEnd: '2026-09-10',
  ...
  },
  {
    ...
    applicationPeriodStart: '2026-08-10',
    applicationPeriodEnd: '2026-09-18',
  ...
  },
  {
    ...
    applicationPeriodStart: '2026-07-20',
    applicationPeriodEnd: '2026-08-26',
  ...
  },
  {
    ...
    applicationPeriodStart: '2026-08-01',
    applicationPeriodEnd: '2026-09-28',
  ...
  },
  {
    ...
    applicationPeriodStart: '2026-08-05',
    applicationPeriodEnd: '2026-09-14',
  ...
  },
  {
    ...
    applicationPeriodStart: '2026-08-02',
    applicationPeriodEnd: '2026-09-22',
  ...
  },
  {
    ...
    applicationPeriodStart: '2026-08-05',
    applicationPeriodEnd: '2026-09-04',
  ...
  },
  {
    ...
    applicationPeriodStart: '2026-08-12',
    applicationPeriodEnd: '2026-09-25',
...
const DESCRIPTIONS: Record<string, { description: string }> = {
  'public-data': {
    description:
